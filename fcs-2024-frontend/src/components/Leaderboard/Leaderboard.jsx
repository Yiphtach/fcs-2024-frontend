            ...
            <table className="w-full text-center border-collapse border border-gray-700">
                <thead>
                    <tr className="bg-gray-800">
                        ...
                        <th className="border border-gray-600 px-4 py-2">Character</th>
                        <th className="border border-gray-600 px-4 py-2">Wins</th>
                        <th className="border border-gray-600 px-4 py-2">Total Fights</th>
                        <th className="border border-gray-600 px-4 py-2">Win Rate</th>
                    </tr>
                </thead>
                <tbody>
                    {displayedCharacters.map((character, index) => (
                        <LeaderboardRow key={character._id} rank={(currentPage - 1) * charactersPerPage + index + 1} character={character} />
                    ))}
                </tbody>
            </table>
